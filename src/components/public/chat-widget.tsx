...
export function ChatWidget() {
  ...
  const remainingRef = useRef(RATE_LIMIT_MAX)
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              color: isAtLimit ? "var(--destructive)" : "var(--muted-foreground)",
            }}
          >
            {isAtLimit
          ...
          {error && !isAtLimit && (
            <div
              ...
              style={{ color: "var(--destructive)", borderTop: "1px solid var(--border)" }}
            >
          ...
          <div
            ...
            style={{ borderTop: error && !isAtLimit ? undefined : "1px solid var(--border)" }}
          >
            <textarea
              ref={inputRef}
              value={input}
      ...
      >
        {!open && hasMessages && (
          <span
            ...
            style={{ background: "var(--destructive)", borderColor: "var(--background)" }}
            aria-hidden="true"
          />
        )}
